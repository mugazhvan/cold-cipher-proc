# KisanFlow Demo Links & Resources

This document contains all official public URLs for testing, evaluating, and viewing the KisanFlow platform.
...
You can explore the Operator and Administrator flows using the following public demo personas:

* **Mandi Operator (Admin)**: `operator1` / `password123`
* **DCA Administrator**: `admin@kisanflow.gov.in` / `password123`

*(The Farmer App uses a mobile number and standard OTP `123456` for instant login.)*

---

## QR Codes

*You can generate QR codes using the URLs provided above to embed directly into your presentation slides.*
