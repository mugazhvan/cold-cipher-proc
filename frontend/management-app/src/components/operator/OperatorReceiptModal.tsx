        ...
        <div className="p-6 space-y-5 max-h-[75vh] overflow-y-auto text-xs">
          ...
          <div className="bg-slate-800/80 border border-slate-700 rounded-2xl p-5 space-y-4">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 text-slate-300">
              ...
              <div>
                <span className="text-slate-400 block text-[11px]">Token No</span>
              ...
              <div>
                <span className="text-slate-400 block text-[11px]">Net Weight</span>
              ...
              <div>
                <span className="text-slate-400 block text-[11px]">Mandi Centre</span>
