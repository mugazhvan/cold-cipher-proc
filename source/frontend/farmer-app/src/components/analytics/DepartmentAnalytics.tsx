...
export const DepartmentAnalytics: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      {/* Header Banner */}
      <div className="bg-gradient-to-r from-indigo-900 via-slate-900 to-slate-950 text-white rounded-2xl p-6 shadow-lg border border-indigo-950">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-5 shadow-xs">
          ...
          <div className="text-2xl font-black text-indigo-700 font-mono mt-1">21.4 mins</div>
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-5 shadow-xs">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          ...
          <div className="bg-emerald-50/70 border border-emerald-200 rounded-xl p-4">
            ...
            <div className="mt-3 text-xs bg-white p-2.5 rounded-lg border border-emerald-200 text-slate-800 font-medium">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-5 shadow-xs">
        <div className="flex items-center justify-between mb-4 border-b border-slate-100 pb-3">
          ...
          <span className="text-[11px] text-slate-500 font-mono">Immutable Event Ledger</span>
        </div>

        <div className="space-y-2.5 text-xs font-mono">
          <div className="bg-slate-50 p-2.5 rounded-lg border border-slate-200 flex items-center justify-between">
            <div className="flex items-center space-x-2">
              <span className="text-slate-400">09:35:12</span>
          ...
          <div className="bg-slate-50 p-2.5 rounded-lg border border-slate-200 flex items-center justify-between">
            <div className="flex items-center space-x-2">
              <span className="text-slate-400">09:15:00</span>
          ...
          <div className="bg-slate-50 p-2.5 rounded-lg border border-slate-200 flex items-center justify-between">
            <div className="flex items-center space-x-2">
              <span className="text-slate-400">08:45:22</span>
              <span className="text-indigo-700 font-bold">[GATE_SCAN]</span>
              <span className="text-slate-800">
                Token #KF-2026-0945 verified at Samrala Gate 1 • Vehicle PB-10-EA-1922 admitted
              </span>
            </div>
            <span className="text-indigo-600 text-[10px] font-bold">LOGGED</span>
          </div>
