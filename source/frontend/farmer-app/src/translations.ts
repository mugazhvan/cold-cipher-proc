...
> = {
  en: {
    ...
    govDept: 'SIH26032 Prototype',
    farmerPortal: '🌾 Farmer Portal',
    operatorConsole: '🏢 Mandi Operator Console',
    analyticsPortal: '📊 DCA Analytics & Smart Balancer',
    bookSlot: 'Book Mandi Slot',
    liveTracker: 'Live Yard & Token Tracker',
    jFormReceipt: 'Procurement Receipt',
    ...
    payoutConfirmed: 'Simulated Payment Credited',
    liveWait: 'Avg Wait',
    distance: 'Distance',
    aiRecommendedBadge: 'BEST RECOMMENDATION',
  ...
  hi: {
    ...
    distance: 'दूरी',
    aiRecommendedBadge: 'प्रणाली द्वारा अनुशंसित',
  ...
  pa: {
    ...
    liveWait: 'ਉਡੀਕ ਸਮਾਂ',
    distance: 'ਦੂਰੀ',
    aiRecommendedBadge: 'ਸਿਸਟਮ ਸਿਫ਼ਾਰਸ਼ੀ',
