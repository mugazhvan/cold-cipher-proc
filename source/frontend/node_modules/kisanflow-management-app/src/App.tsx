...
export const App: React.FC = () => {
  return (
    <KisanFlowProvider>
      <div className="min-h-screen bg-zinc-950 text-zinc-100 flex flex-col antialiased selection:bg-sky-500 selection:text-white">
        <OperatorHeader />
        ...
        {/* Operator Footer */}
        <footer className="bg-zinc-900 border-t border-zinc-800 mt-12 py-6 text-xs text-zinc-400">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center space-x-2">
              <span className="font-extrabold text-zinc-100 text-sm">KisanFlow Operator Console</span>
              <span>•</span>
