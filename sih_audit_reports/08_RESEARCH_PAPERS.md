...
- **How KisanFlow Uses This**: ⚠️ SIMULATED. The schema inside mockData.ts and the Crop database models are built directly using the government's official taxonomy. This ensures our DBT (Direct Benefit Transfer) simulations are domain-accurate.
