...
| **Frontend Web Hosting** | Vercel | Pro | \ / user / mo | None | 🛠️ PROPOSED (Required for production scale) |
...
| **Database (PostgreSQL)** | Render | Basic-256MB | ~\ / mo | N/A (1GB storage included) | 🛠️ PROPOSED (Required for persistence) |
